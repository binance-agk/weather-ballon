...
def getTVPVariableRbf(f, lat0, lon0, h0, limitangle, limitinterpolateforlayer):
    ...
    if limitinterpolateforlayer == 0:
        ...
        return [Vv[iTR][jTR], Vu[iTR][jTR], T[iTR][jTR], P, hnex]
...
def d9(f, var, lat0, lon0, h0, limitangle, limitinterpolateforlayer):
    try:
        ...
        if lon0 < 0:
            lon0 = 360 + lon0
        rbf = getVariableRbf(f, var, lat0, lon0, h0,
                             limitangle, limitinterpolateforlayer)
