...
# lon0 = 122
#
# filename = "GFS_Global_0p5deg_ana_{0}{1}{2:0=2d}_{3:0=2d}00.grib2.nc" \
#     .format(year, month, day, hour)
# print(filename)
# solution = Solution(lat0, lon0, day, month, year, hour, 0, filename, 1, 10, None, None, 0, 22000, 15000)
